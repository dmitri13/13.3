# Домашнее задание к занятию "`13.3 Защита сети`" - `Овчинников Дмитрий`
...
![nmap](https://github.com/dmitri13/13.3/blob/main/img/nmap.png)
...
![fail2ban](https://github.com/dmitri13/13.3/blob/main/img/fail2ban.png)

![suricata](https://github.com/dmitri13/13.3/blob/main/img/suricata2.png)

fail2ban заблокировал ip с которого происходят попытки поключения на 10 минут  
suricata зафиксировала потенциальное ssh сканирование 
